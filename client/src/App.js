        ...
        <BrowserRouter>
            <nav className="menu">
                <div className="button-painel">
                    <Link to="/"><Button variant="light"><FontAwesomeIcon icon={ faHouse} /></Button></Link>
                    <Link to="/listaprodutos"><Button variant="light">Categoria</Button></Link>           
                    <Link to="/paineldecontrole"><Button variant="light"><FontAwesomeIcon icon={ faSun} /></Button></Link>
                
                <div className="CartShopping" value="produtosCart"><FontAwesomeIcon icon={faShoppingCart} />               
</div>
</div>
            </nav>
